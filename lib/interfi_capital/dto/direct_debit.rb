class InterfiCapital::Dto::DirectDebit < InterfiCapital::Dto::Base
  ...
  REPAYMENT_CALCULATION_FREQUENCY = %w(Once Weekly WeeklyFour WeeklyTrue Fortnightly FortnightlyTwo FortnightlyTrue Monthly Annually).freeze
  RECURRENCE_FREQUENCY = %w(Once Weekly Fortnightly Monthly Annually).freeze
